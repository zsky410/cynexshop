document.addEventListener('DOMContentLoaded', function () {
  ...
  function createAmbientBackground() {
    // Check if the canvas already exists (might be created by auth.js)
    ...
    canvas.style.opacity = '0.3'; // Match the opacity in auth.js
    ...
    // Create particles
    const particles = [];
    const particleCount = 70; // Increase particle count
